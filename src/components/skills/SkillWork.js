...
const SkillWork = () => {
    return (
        ...
        <div className="SkillWork_container">

            <div className="skill_box">
                <h3 className="skill_box_company">Swedish Red Cross</h3>
                <p className="skill_box_titel">Project leader and organisational developer</p>
                <p className="skill_box_year">August 2018 - ongoing</p>
            </div>
